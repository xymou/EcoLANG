...
simu_config_path="../configs/syn_persona.json"
config_output_dir="../scen_configs/persona_hisim_vocab/"
output_dir="../output/persona_hisim_vocab/"
iter_output_dir="../iter_output/persona_hisim_vocab/"
sample_size=5
judge_llm="gpt-4o"
